...
/* ----------------------------------------------------------------------- 
  ...
  TIM_OCInitStructure.TIM_Pulse = Yaw_Val;	   //设置跳变值，当计数器计数到这个值时，电平发生跳变
  ...
  TIM_OCInitStructure.TIM_OutputState = TIM_OutputState_Enable;
  TIM_OCInitStructure.TIM_Pulse = Roll_Val;	  //设置通道2的电平跳变值，输出另外一个占空比的PWM
  TIM_OC2Init(TIM3, &TIM_OCInitStructure);	  //使能通道2
  TIM_OC2PreloadConfig(TIM3, TIM_OCPreload_Enable);

  /* PWM1 Mode configuration: Channel3 */
  TIM_OCInitStructure.TIM_OutputState = TIM_OutputState_Enable;
  TIM_OCInitStructure.TIM_Pulse = Mode_Val;	//设置通道3的电平跳变值，输出另外一个占空比的PWM
